...
import { CameraOff, RefreshCw, Home } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-dark-900 flex items-center justify-center px-6">
      <div className="text-center">
        <CameraOff size={48} className="mx-auto text-gold-light/40 mb-4" />
        <h1 className="font-serif text-3xl font-bold mb-2">Кадр не получился</h1>
